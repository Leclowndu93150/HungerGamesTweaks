...
public class FreezePositionRenderer {
    ...
    public static void register() {
        WorldRenderEvents.LAST.register(FreezePositionRenderer::onRenderLast);
    }
    ...
    private static void onRenderLast(WorldRenderContext context) {
        ...
        boolean holdingWand = mc.player.getMainHandItem().getItem() instanceof com.leclowndu93150.hungertweaks.FreezeWandItem
                || mc.player.getOffhandItem().getItem() instanceof com.leclowndu93150.hungertweaks.FreezeWandItem;
